$(function() {
  ...
  function interaction() {
    var dataUrl = apiUrl + 'community/topic/topiclist?categoryid=1011&page=' + pageIndex;
    $.get(dataUrl, function(data) {
      ...
      if (arr.indexOf(dataUrl) == -1) {
        arr.push(dataUrl);
        $(".page").append("<ul class=ul" + pageIndex + "></ul>");
        for (var i = 0; i < len; i++) {
          $(".ul" + pageIndex).append('<li><div class="flow"><a href="" data-url="houpixapp://topic/"><img src="" alt="" class="img1"></a></div><div class="clearfix count"><p class="message"> <i class="yuyue icon-pinglun ic"></i><span class="num"></span><i class="yuyue icon-liulan ic"></i><span class="view"></span></p></div></li>');
        }
